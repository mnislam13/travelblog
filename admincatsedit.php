...
<head>
  ...
  <title>Dashboard - Edit Category | TravelBlog</title>
  ...
  <div class="admin-wrapper">
    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <form action="admincatsedit.php" method="post">
              ...
              <div>
                  <button type="submit" name="update-cat" class="btn btn-big btn-success">Update Category</button>
              </div>          
            </form>
        </div>
    </div>
