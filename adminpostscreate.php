...
<head>
    ...
    <title>Dashboard - Add Post | TravelBlog</title>
    ...
    <div class="admin-wrapper">
        ...
        <div class="admin-content">
            ...
            <div class="content">
                ...
                <form action="adminpostscreate.php" method="post" enctype="multipart/form-data">
                    ...
                    <div>
                        <button type="submit" name="add-post" class="btn btn-big btn-success">Add Post</button>
                    </div>
